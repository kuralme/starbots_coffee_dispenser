...
class ObjectDetection(Node):
    ...
    def callback(self, msg: PointCloud2) -> None:
        try:
            ...
            filtered_cloud_objects = self.filter_cloud(cloud, min_x_dist=-0.1, max_x_dist=0.4, min_y_dist=0.2, max_y_dist=0.7, min_height=0.0, max_height=0.1)
    ...
    def pub_object_marker(self, object_centroids: List[List[float]], object_dimensions: List[List[float]]) -> None:
        ...
        for idx, (centroid, dimension) in enumerate(zip(object_centroids, object_dimensions)):
            ...
            marker.pose.position.x = centroid[0] - 0.021
